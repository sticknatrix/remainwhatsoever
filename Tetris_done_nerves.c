     ...
     instruction[4]&&instruction[5]&&instruction[6]&&instruction[7])
{
  ...
  //printf("binda"),getchar(),getchar();
   ...
   if ( linestr_flag==1)
   {
   	//printf("bin an Zeile loeschen gesprungen"),getchar();
   	 address.bit_2[0]=operand2.bit_2[0];
      address.bit_2[1]=operand2.bit_2[1];
      address.bit_2[2]=operand2.bit_2[2];
      address.bit_2[3]=operand2.bit_2[3];
...
int drawscreen(int nodraw)
{
 ...
 while(n<9)
 {
    ...
    (screen[(ram[7*16+9+128]*7> 15*7 ? 15*7 : ram[7*16+9+128]*7)+ram[7*16+9+1+128]+(8-n)%3+((8-n)/3)*7]=ram[7*16+128+(8-n)]==1? 219 : screen[ram[7*16+9+128]*7> 15*7]),n++;
   }
   	else if ( hvflip==0)
 	{
      ...
      //if(errorfill==1)break;
    (screen[(ram[7*16+9+128]*7> 15*7 ? 15*7 : ram[7*16+9+128]*7) +ram[7*16+9+1+128]+n%3+(n/3)*7]=ram[7*16+128+n]==1? 219 : screen[ram[7*16+9+128]*7> 15*7]),n++;
   }
 } 
 n=0;
 if ( nodraw==0)
...
int main(void)
{
  ...
  RAM(47,MOVA) RAM(48,128)
  RAM(49,MOVDA)
  RAM(50,MOVDO) RAM(51,101)
  RAM(52,MOVD) RAM(53,102)
  RAM(54,MOVA) RAM(55,101)
  RAM(56,JCMPS) RAM(57,7) RAM(58,76)
  RAM(59,MOVD) RAM(60,101)
  RAM(61,MOVDO) RAM(62,101)
  RAM(63,ADD) RAM(64,7)
  RAM(65,MOVDO) RAM(66,101)
  RAM(67,JCMP) RAM(68,7*15+128) RAM(69,0)
  RAM(70,MOVA) RAM(71,0)
  RAM(72,MOVDA)
  RAM(73,JCMP) RAM(74,0) RAM (75,52)
  RAM(76,MOVAA) RAM(77,101)
  RAM(78,MOVDA)
  RAM(79,MOVDA) RAM(80,MOVDA)
  RAM(81,STORB) RAM(82,7)
  RAM(83,MOVA) RAM(84,0)
  RAM(85,MOVDA)
  RAM(86,JCMP) RAM(87,0) RAM(88,52)
  RAM(100,102)
  RAM(102,1)
 ...
 videoclear();
  ...
  if (drawscreen(1)==1)ram[106]=rotate=rotate_old,pos=pos_old,ram[7*16+9+1+128]=pos_old;else pos_old=pos,rotate_old=rotate;
